       ...
       <!-- Page Top Navigation  -->
        ...
        <div class="d-sm-flex align-items-center justify-content-between mb-4">
          ...
          <div class="row">
			...
			ID:
			<input type="text" class="form-control" name="prodid" value="<c:out value="${product.prodid}"/>" readonly/> <br>
			Name:
			<input type="text" class="form-control" name="prodName" value="<c:out value="${product.prodName}" />" readonly/><br>
			Price:
			<input type="text" class="form-control" name="prodPrice" value = "<c:out value="${product.prodPrice}" />" readonly/><br>
			Quantity:
			<input type="text" class="form-control" name="prodQuantity" value="<c:out value="${product.prodQuantity}" />" readonly/><br>
			Supplier ID:
			<input type="text" class="form-control" name="supplierid" value="<c:out value="${product.supplierid}" />" readonly/><br>
			Product Type:
			<input type="text" class="form-control" name="prodType" value="<c:out value="${product.prodType}" />" readonly/><br>
