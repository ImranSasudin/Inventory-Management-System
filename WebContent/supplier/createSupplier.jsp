       ...
       <!-- Page Top Navigation  -->
        ...
        <div class="d-sm-flex align-items-center justify-content-between mb-4">
          ...
          <div class="row">
			...
			<form action = "/Inventory/SupplierController" method = "post">
			Name:
			<input type = "text" class="form-control" placeholder = "Enter supplier name" name="suppName" required><br>
			Address:
			<input type = "text" class="form-control" placeholder = "Enter supplier address" name="suppAddress" required><br>
			Contact:
			<input type = "text" class="form-control" placeholder = "Enter supplier contact" pattern="^[0-9]*$" title="Put Number Only" name="suppContact" required><br>
			Email:
			<input type = "email" class="form-control" placeholder = "Enter supplier email " name="suppEmail" required><br>
